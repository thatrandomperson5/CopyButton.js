...
function updateCopybutton() {
  document.querySelectorAll("pre:has(code.docopy:not([data-copybutton-automatic-seen]))").forEach((item) => {
    ...
    code.setAttribute("data-copybutton-automatic-seen", "true");
  });
}

if (document.currentScript && !("noUpdate" in document.currentScript.dataset)) {
  updateCopybutton();
}
